#undef FIRESIMULATIONEDITORMODULE_API
...
#define UE_MODULE_NAME "FireSimulationEditorModule"
...
#define FIRESIMULATIONEDITORMODULE_API DLLEXPORT
#define FIRESIMULATION_API DLLIMPORT
